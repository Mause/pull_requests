...
github = sgqlc.types.Schema()


# Unexport Node/PageInfo, let schema re-declare them
github -= sgqlc.types.relay.Node
github -= sgqlc.types.relay.PageInfo
...
# Schema Entry Points
########################################################################
github.query_type = Query
github.mutation_type = Mutation
github.subscription_type = None
